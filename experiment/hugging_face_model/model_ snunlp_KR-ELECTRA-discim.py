...
train_dataset = SimilarityDataset("/data/ephemeral/home/becky/data/train_trans_downs.csv", tokenizer)
...
model = AutoModelForSequenceClassification.from_pretrained("snunlp/KR-ELECTRA-discriminator", num_labels=1)
model.to(device)
training_args = TrainingArguments(
    output_dir='./KR-ELECTRA-discriminator',
    num_train_epochs=40,
    ...
    save_total_limit=2,
    report_to="wandb",
    run_name="KR-ELECTRA-discriminator",
    save_strategy='steps',
...
submission_df.to_csv('/data/ephemeral/home/level1-semantictextsimilarity-nlp-04/KR-ELECTRA-discriminator/submission.csv', index=False)