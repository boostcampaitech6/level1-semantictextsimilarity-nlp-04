...
train_dataset = SimilarityDataset('/data/ephemeral/home/becky/data/swap_concat_new.csv', tokenizer)
...
model = AutoModelForSequenceClassification.from_pretrained("BM-K/KoSimCSE-roberta-multitask", num_labels=1)
model.to(device)
training_args = TrainingArguments(
    output_dir='./KoSimCSE-roberta-multitask',
    ...
    save_total_limit=2,
    report_to="wandb",
    run_name="KoSimCSE-roberta-multitask",
    save_strategy='steps',
...
submission_df.to_csv('/data/ephemeral/home/level1-semantictextsimilarity-nlp-04/KoSimCSE-roberta-multitask/submission.csv', index=False)