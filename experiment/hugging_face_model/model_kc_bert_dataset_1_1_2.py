...
train_dataset = SimilarityDataset('/data/ephemeral/home/becky/data/kakao/dataset_ver1.1.2.csv', tokenizer)
...
model = AutoModelForSequenceClassification.from_pretrained("beomi/kcbert-large", num_labels=1)
model.to(device)
training_args = TrainingArguments(
    output_dir='./kc-bert/dataset_1_1_2',
...
submission_df.to_csv('/data/ephemeral/home/level1-semantictextsimilarity-nlp-04/kc-electra/dataset_1_1_2/submission.csv', index=False)