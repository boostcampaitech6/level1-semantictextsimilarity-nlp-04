...
train_dataset = SimilarityDataset("/data/ephemeral/home/becky/data/trans_mix.csv", tokenizer)
dev_dataset = SimilarityDataset("/data/ephemeral/home/becky/data/trans_pre_dev.csv", tokenizer)
test_dataset = SimilarityDatasetWithoutLabels('/data/ephemeral/home/becky/data/trans_pre_test.csv', tokenizer)  # For prediction
# , hidden_dropout_prob=0.3
model = AutoModelForSequenceClassification.from_pretrained("team-lucid/deberta-v3-base-korean", num_labels=1)
model.to(device)
